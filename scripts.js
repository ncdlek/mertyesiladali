document.addEventListener('DOMContentLoaded', () => {
  ...
  const initLanguageSelector = () => {
    ...
    // Close dropdown when clicking outside or when menu is toggled
    ...
    if (navToggle) {
      navToggle.addEventListener('click', closeLanguageDropdown);
    }
    ...
    languageOptions.forEach(option => {
      option.addEventListener('click', (e) => {
        ...
        const langText = option.textContent.trim().split(' ')[1] || lang.toUpperCase();
